...
a configuration file from an outer directory.
"""

import os
from succulent.api import SucculentAPI

# Load configuration file from ../tests/configuration.yml
path = os.path.join(os.path.dirname(__file__), '..', 'tests', 'configuration.yml')
